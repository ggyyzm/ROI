...
if __name__ == '__main__':
    ...
    # test no parameters multiple band
    ...
    #
    # outImg_test = CXImage()
    # strImgPath = r"C:\Users\Admin\Desktop\14.tiff"
    ...
    # test no parameters single band
    ...
    #
    # outImg = CXImage()
    # strImgPath = r"C:\Users\Admin\Desktop\16.tiff"
    # outImg.Create(xImgIn.m_nBands, xImgIn.m_nLines, xImgIn.m_nSamples, np.uint8, strImgPath)
    #
    # for i in range(partionNum):
    #     currentWidth = xImgIn.currentWidth
